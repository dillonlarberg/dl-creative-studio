 ...
 *   {source_basename}_{app_slug}_{w}x{h}_v{n}
 *
 * Example: "image(2).png" + ad-resizing + 1080x1920 + v2 → "image(2)_resize_1080x1920_v2"
 *
...
export function buildOutputFilename(
  ...
  return `${basename}_${appSlug}_${width}x${height}_v${version}`;
}
