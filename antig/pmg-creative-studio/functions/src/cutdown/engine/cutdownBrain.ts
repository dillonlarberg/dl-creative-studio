...
import type { CutdownBrain, VideoRef } from "./seams";
import { z } from "zod";
import { VideoAnalysisSchema, SegmentSchema, CutdownPlanSchema, type VideoAnalysis, type Segment, type Angle, type CutdownPlan, type SampleMusicTrack } from "./types";
import { angleGuidance, orderSegments, ANGLES, angleLabel } from "./angles";
import { clampSegments, planCuts, barGridBoundaries } from "./planCuts";
import { type GenAiLike, uploadAndActivate, generateJson } from "./geminiCore";
