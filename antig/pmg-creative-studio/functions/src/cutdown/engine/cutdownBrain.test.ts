...
import { GeminiCutdownBrain } from "./cutdownBrain";
import type { GenAiLike } from "./geminiCore";
import type { SampleMusicTrack } from "./types";
...
const analysis = JSON.parse(analysisJson.text) as import("./types").VideoAnalysis;
...
const selected: import("./types").Segment[] = [
